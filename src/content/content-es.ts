...
export const tool: _tool = {
  PDF_to_CSV: {
    title: "Convertir PDF a CSV",
    seoTitle:
      "Convertir PDF a CSV en línea - Convertidor gratuito de PDF a CSV | PDFEquips",
